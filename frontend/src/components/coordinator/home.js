...
export default function Home({role}) {
  ...
  useEffect(() => {
    if(teacherDetails){
      ...
      localStorage.setItem("details", JSON.stringify(teacherDetails))
  ...
  return (
    <div className="flex flex-col fixed">
      ...
      <div className="flex">
        ...
        <div className="body mt-[100px] ml-[180px] h-[calc(100vh-100px)] w-[calc(100vw-180px)] max-w-[calc(100vw-180px)] relative">
